...
**Title:** Observability, Reliability & Operations Engine
**Architecture reference:** DOC 18
**Status:** NOT_IMPLEMENTED — foundation only

## Boundary rules

- Other modules may import **only** from `@modules/module-18-observability` (the `index.ts` public contract).
