...
**Title:** Experimentation & Growth Loop Engine
**Architecture reference:** DOC 11
**Status:** NOT_IMPLEMENTED — foundation only

## Boundary rules

- Other modules may import **only** from `@modules/module-11-experiment` (the `index.ts` public contract).
